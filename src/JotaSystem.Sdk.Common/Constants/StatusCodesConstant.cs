namespace JotaSystem.Sdk.Common.Constants
{
    public static class StatusCodesConstant
    {
        ...
        public static class Http
        {
            ...
            public const int ImATeapot = 418; // Easter egg :)
        ...
        public static class Custom
        {
            ...
            public const int UserAlreadyExists = 1003;

            // Operações
            public const int InvalidOperation = 2001;
            public const int OperationFailed = 2002;
            public const int EntityLocked = 2003;

            // Integrações / Serviços
            public const int ExternalServiceUnavailable = 3001;
            public const int Timeout = 3002;
            public const int InvalidResponse = 3003;
        }
    }
}